...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+3,"LorR", false,-1);
    tracep->declBit(c+4,"AorL", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+3,(vlSelf->LorR));
    bufp->fullBit(oldp+4,(vlSelf->AorL));
    bufp->fullCData(oldp+5,(vlSelf->dout),8);
    bufp->fullCData(oldp+6,(vlSelf->top__DOT__tmp),8);
}
